...
function mapError(message: string): string {
  ...
  if (message.includes("Email not confirmed"))
    return "Email adresini henüz onaylamamışsın. Gelen kutunu kontrol et.";
...
const URL_ERRORS: Record<string, string> = {
  auth_callback_failed: "Google ile giriş başarısız. Tekrar dene.",
};

type Props = { urlError?: string };
...
export function LoginForm({ urlError }: Props) {
  ...
  const [error, setError] = useState(
    urlError ? (URL_ERRORS[urlError] ?? "Bir hata oluştu.") : "",
  );
