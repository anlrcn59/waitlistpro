    ...
    <div className="mx-auto grid max-w-2xl gap-4 sm:grid-cols-2">
      ...
      <div className="rounded-xl border bg-card p-8 shadow-sm">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Başlamak için</p>
        </div>
        ...
        <div className="mt-8 w-full rounded-lg border py-2.5 text-center text-sm font-semibold text-muted-foreground">
          Mevcut plan
        </div>
      </div>
